...
public class DealActivity extends AppCompatActivity {
    ...
    private static final int PICTURE_RESULT = 120; // the answer to everything
    EditText txtTitle;
    EditText txtDescription;
    ImageView imageView;
    EditText txtPrice;

    private TraveDeal deal;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TraveDeal deal = (TraveDeal) intent.getSerializableExtra("Deal");
        if(deal == null){
            deal = new TraveDeal();
        }
        this.deal = deal;
    ...
    private void deleteDeal(){
        if (deal==null){
            Toast.makeText(this, "Please save the deal before deleliting", Toast.LENGTH_SHORT).show();
            return;
        }
